using Dedalo.API.Middlewares;
using Dedalo.Application;
...
using Dedalo.API.Filters;

using NAuth.DTO.Settings;
using zTools.DTO.Settings;

namespace Dedalo.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment() || env.EnvironmentName == "Docker")
            {
                ...
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Dedalo.API v1");
                });
            }
